...
bool THJsonStreamReader::isProperty (void) const {
    return(d->lastToken == PropertyNumerical ||
           d->lastToken == PropertyString ||
           d->lastToken == PropertyFalse ||
           d->lastToken == PropertyTrue ||
           d->lastToken == PropertyNull);
}
